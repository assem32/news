                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                            ...
                            child: Image(
                              width: MediaQuery.of(context).size.width*0.7244897959183673,
                              height: MediaQuery.of(context).size.height*0.203393085787452,
                              fit: BoxFit.fill,
                              image: NetworkImage('https://img.freepik.com/free-photo/nature-colorful-landscape-dusk-cloud_1203-5705.jpg?w=1060&t=st=1686670375~exp=1686670975~hmac=e7c38f30b1fc6634512d807e74897e0415050909bab602f9a465d838cbad7edf',),
                            )),
                        SizedBox(
                          height: MediaQuery.of(context).size.height*0.0128040973111396,
                        ),
                        Text('News Title here',style: Theme.of(context).textTheme.displaySmall,),
